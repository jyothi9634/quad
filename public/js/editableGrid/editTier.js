...
{ 
	this.editableGrid = new EditableGrid("ptl_tiers", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("editPtlTier?db_tablename=ptl_tiers");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Are you sure want to delete this Tier')  ) {

        $.ajax({
		url: '/ptlmasters/deletePtlTier',
		type: 'POST',
		dataType: "html",
		data: {
		...
		{ 
			...
			alert('Tier is deleted successfully.');
			}else if(response == "sector"){
				alert('Sector are allocated to this Tier. Please delete those Sectors before deleting this Tier.');
			}else{
				alert('Eror occured while deleting tier, Please try after sometime.');
			}
		},
		error: function(XMLHttpRequest, textStatus, exception) { alert("Ajax failure\n" + errortext); },
		async: true
