...
{ 
	this.editableGrid = new EditableGrid("ptl_zones", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("editPtlZone?db_tablename=ptl_zones");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  if ( confirm('Are you sure want to delete this Zone' )  ) {
		...
		{ 
			...
			alert('Zone is deleted successfully.');
		}else if(response == "zone"){
				alert('This zone is associated with sectors. Please delete those sectors before deleting this Zone.');
			}else{
				alert('Eror occured while deleting Zone, Please try after sometime.');
			}
		},
		error: function(XMLHttpRequest, textStatus, exception) { alert("Ajax failure\n" + errortext); },
		async: true
