...
{      
	$.ajax({
		url: '/ptlmasters/editablePincodes',
		type: 'POST',
		dataType: "html",
	   		data: {
...
{ 
	this.editableGrid = new EditableGrid("ptl_pincodexsectors", {
		enableSort: true,
...
DatabaseGrid.prototype.fetchGrid = function()  {
	...
	this.editableGrid.loadJSON("editPtlPincode?db_tablename=ptl_pincodexsectors");
};
...
DatabaseGrid.prototype.deleteRow = function(id) 
{
  ...
  var self = this;
  $.ajax({
		url: '/ptlmasters/checkPtlPincode',
		type: 'POST',
		dataType: "html",
		data: {
		...
		{ 
			if (response == "ok" )
		        alert('Please delete the posts associated with this pincode.' ); 
                    else{
                        if ( confirm('Are you sure want to delete this Pincode')  ) {

                            $.ajax({
                                    url: '/ptlmasters/deletePtlPincode',
                                    type: 'POST',
                                    dataType: "html",
                                    data: {
                                            tablename : self.editableGrid.name,
