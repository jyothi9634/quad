	...
	<div class="filter-expand-block">
		...
		<div class="search-block inner-block-bg margin-bottom-less-1">
			...
			<div>
				...
				<span class="search-result">{{$commonComponent->getVehicleType($seller_post_items[0]->lkp_vehicle_type_id)}}</span>
			</div>	
			...
			<div>
				...
				<span class="search-result">{{$commonComponent->getSellerPostStatuss($seller_post[0]->lkp_post_status_id)}}</span>
			</div>
	...
	<div class="filter-expand-block">
		<div class="gray-bg">
			...
			<div class="gray-bg">
				...
				<div class="col-md-3 form-control-fld">
					<div class="normal-select">
					{!! $filter->field('spi.driver_availability') !!}
					</div>
				</div>
