					...
					<div class="inner-block-bg inner-block-bg1">
						...
						<div class="col-md-8 data-div">
							...
							<div class="col-md-3 padding-left-none data-fld">						
								...
								<span class="data-head">Lease Term</span> <span
                                                                    class="data-value">
                                                                   @if($truckleaseLeaseTermId == 1)
                                                                   {{--*/ $leaseType = 'Days' /*--}}
                                                                   Daily
                                                                   @elseif($truckleaseLeaseTermId == 2)
                                                                   {{--*/ $leaseType = 'Weeks' /*--}}
                                                                   Weekly
                                                                   @elseif($truckleaseLeaseTermId == 3)
                                                                   {{--*/ $leaseType = 'Months' /*--}}
                                                                   Monthly
                                                                   @elseif($truckleaseLeaseTermId == 2)
                                                                   {{--*/ $leaseType = 'Years' /*--}}
								...
								<span class="data-head">Driver</span> <span
                                                                    class="data-value">
								...
								<span class="data-head">Payment</span> <span
                                                                    class="data-value">
                                                                    @if ($orderDetails->payment_mode == 'Advance')                       
                                                                    Online Payment
                                                                    @else
                                                        ...
                                                        <div class="col-md-3 padding-left-none data-fld">
								<span class="data-head">Document</span> <span
									class="data-value">0</span>
							</div>
                                                    
                                                    <div class="col-md-3 padding-left-none data-fld">
								<span class="data-head">Vehicle Make & Model & Year</span> <span
									class="data-value"> {{ $vehicleMakeModelYear }}</span>
							</div>
						...
						<div class="col-md-4 order-detail-price-block">
							...
							<div>
								<span class="data-head">Total Price</span> <span
									...
									number_format($orderDetails->inv_price,2) !!}
									@else{!! number_format($orderDetails->price,2) !!} @endif </span>
							</div>
