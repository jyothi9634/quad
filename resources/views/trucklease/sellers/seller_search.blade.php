							...
							<div class="col-md-12 padding-none">
								<div class="col-md-4 form-control-fld">
									<div class="input-prepend">
										...
										{!! Form::text('from_location', Session::get('session_from_location'), ['id' => 'from_location','class' => 'top-text-fld form-control clsLocation', 'placeholder' => 'Location*']) !!}
										{!! Form::hidden('from_city_id', Session::get('session_from_city_id'), array('id' => 'from_location_id')) !!}
										{!! Form::hidden('seller_district_id', Session::get('session_seller_district_id'), array('id' => 'seller_district_id')) !!}
								...
								<div>
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											...
											{!! Form::text('dispatch_date', Session::get('session_dispatch_date'), ['id' => 'dispatch_date1','class' => 'form-control clsFromDate from-date-control','readonly'=>true, 'placeholder' => 'From Date*']) !!}
									...
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											<span class="add-on"><i class="fa fa-calendar-o"></i></span>
											{!! Form::text('delivery_date', Session::get('session_delivery_date'), ['id' => 'delivery_date1','class' => 'clsToDate form-control to-date-control','readonly'=>true, 'placeholder' => 'To Date*']) !!}
									...
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											...
											{!! Form::select('lkp_trucklease_lease_term_id', (['' => 'Lease Term*'] + $getAllleaseTypes ), Session::get('session_lease_type'), ['class' => 'selectpicker','id' => 'lkp_trucklease_lease_term_id']) !!}
										</div>
									</div>
									<div class="col-md-4 form-control-fld pull-left">
										<div class="input-prepend">
											<span class="add-on"><i class="fa fa-truck"></i></span>
											{!! Form::select('lkp_vehicle_type_id', (['' => 'Vehicle Type*'] + $vehicletypemasters +['20'=>'Vehicle Type (Any)']), Session::get('session_vehicle_type'), ['class' => 'selectpicker','id' => 'vechile_type']) !!}
										</div>
									</div>
									<div class="col-md-4 form-control-fld">
