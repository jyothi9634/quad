...
{{--*/ $docs_seller_lease    =   $commoncomponent->getGsaDocuments(SELLER,$serviceId,$seller_post[0]->id); /*--}}      
{{--*/ $docCount_lease = count($docs_seller_lease) /*--}}

@if($leaseterm [0]->id == 1)
    {{--*/ $submitQuoteClass = 'fourdigitstwodecimals_deciVal' /*--}}
@elseif($leaseterm [0]->id == 2)
    {{--*/ $submitQuoteClass = 'fivedigitstwodecimals_deciVal' /*--}}
@elseif($leaseterm [0]->id == 3)
    {{--*/ $submitQuoteClass = 'sixdigitstwodecimals_deciVal' /*--}}
@elseif($leaseterm [0]->id == 4)
			...
			<div class="search-block inner-block-bg margin-bottom-less-1">
				<div class="from-to-area">
					<span class="search-result">
						...
						<span class="location-text">{!! $fromlocations[0]->city_name !!}</span>
					</span>
				</div>
				<div class="date-area">
				...
				<div>
					...
					<span class="search-result">{!! $leaseterm [0]->lease_term!!}</span>
				</div>
			   	...
			   	<div class="expand-block">
			   		<div class="col-md-12">
								...
								<div class="col-md-2 padding-left-none data-fld">
									<span class="data-head">Minimum Lease Period</span>
									<span class="data-value">
									{{$seller_post_items[0]->minimum_lease_period}} 
									@if($seller_post_items[0]->lkp_trucklease_lease_term_id == 1)
									Days 
									@elseif($seller_post_items[0]->lkp_trucklease_lease_term_id == 2)
									Weeks
									@elseif($seller_post_items[0]->lkp_trucklease_lease_term_id == 3)
									Months
									@else
									Years
									@endif
								...
								<div class="col-md-2 padding-left-none data-fld">
									...
									@if($seller_post_items[0]->fuel_included == 1)
									Included
									@else
									Not Include
									@endif
								...
								<div class="col-md-2 padding-left-none data-fld">
									...
									<span class="data-value">
									@if($seller_post_items[0]->driver_availability == 1)
									With Driver
									@else
									With Out Driver
									@endif
								...
								<div class="col-md-2 padding-left-none data-fld">
									...
									<span class="data-value">
									{{ $commoncomponent->getPriceType($seller_post_items[0]->driver_charges) }}
									</span>
								</div>
								@endif
								{{--*/ $paymenttype =0 /*--}}
						...
						<div class="col-md-1 padding-left-none data-fld">
							...
							<span class="data-value">{!! $docCount_lease !!}</span>
						</div>
						<div class="clearfix"></div>
						<div class="col-md-12 padding-left-none data-fld">
							<span class="data-head">Load Type</span>
							<span class="data-value">{!! rtrim($commoncomponent->truckLeaseLoadTypes($seller_post[0]->id),', ') !!}</span>
						</div>
						<div class="clearfix"></div>
						
						<div class="col-md-12 padding-left-none data-fld">
							<span class="data-head">Permit</span>
							<span class="data-value ">{!! rtrim($commoncomponent->checkPermit($seller_post[0]->id),', ') !!}</span>
						</div>
						<div class="clearfix"></div>
				...
				<div class="main-right">
					...
					<div class="pull-left">
						<div class="info-links" id="seller_post_info_links">
							...
							<a href="#" data-showdiv="ftl-seller-documentation"><i class="fa fa-file-text-o"></i> Documentation <span class="badge">{!! $docCount_lease !!}</span>
							</a>
						</div>
					</div>
                                    ...
                                    <div class="table-data inner-block-bg">                                       
                                        ...
                                        <div class="col-sm-12 padding-right-none">
                                            ...
                                            <ul class="popup-list">                                               
                                                ...
                                                @foreach($docs_seller_lease as $doc)
                                                <li>{{$doc}}</li>
                                                @endforeach
