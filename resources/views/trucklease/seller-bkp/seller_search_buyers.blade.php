					...
					<div class="col-md-12 padding-none">
						<div class="col-md-4 form-control-fld">
							<div class="input-prepend">
								...
								{!! Form::text('from_location', '', ['id' => 'from_location','class' => 'top-text-fld form-control', 'placeholder' => 'Location*']) !!}
						...
						<div>
							<div class="col-md-4 form-control-fld">
								<div class="input-prepend">
									...
									{!! Form::text('dispatch_date', '', ['id' => 'datepicker_search','class' => 'form-control calendar clear-date-from','readonly'=>true, 'placeholder' => 'From Date*']) !!}
							...
							<div class="col-md-4 form-control-fld">
								<div class="input-prepend">
									<span class="add-on"><i class="fa fa-calendar-o"></i></span>
									{!! Form::text('delivery_date', '', ['id' => 'datepicker_to_location_search','class' => 'calendar form-control clear-date-to','readonly'=>true, 'placeholder' => 'To Date*']) !!}
