...
{{--*/  $networkClass = '';   /*--}}
    ...
    @if($routeName == 'communityhome')
     {{--*/  $homeClass = '1' /*--}}
    @else
     {{--*/    $homeClass = '0' /*--}}
     @endif
     
     @if($routeName == 'communityindividualsearch') 
     {{--*/  $individualClass = '1' /*--}}
    @else
     {{--*/    $individualClass = '0' /*--}}
     @endif
   
    @if($routeName == 'communityorganizationsearch')
     {{--*/  $orgClass = '1' /*--}}
    @else
     {{--*/    $orgClass = '0' /*--}}
     @endif
     ...
     @if($routeName == 'communitygroupsearch' || $routeName == 'communitycreategroupform' || $routeName == 'displaygroupdetails')
		...
		<div class="top-menu-strip">
            <div class="container">
                <div class="pull-left">
                    ...
                    <a @if($homeClass == '1') class="active" @endif href="/community/home">Home</a>
                    <a @if($individualClass == '1') class="active" @endif href="/individualsearch">Individuals</a>
                    <a @if($orgClass == '1') class="active" @endif href="/organizationsearch" >Organizations</a>
                    <a @if($networkClass == '1') class="active" @endif  href="/groupsearch" >Groups</a>                  
                </div>
