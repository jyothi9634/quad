...
@section('content')
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <span class="pull-right"><a onclick="return checkSession(18,'/createseller');" href="#"><button class="btn post-btn pull-right">+ Post</button></a></span>
                                        ...
                                        <div class="col-md-12 padding-none">
                                            ...
                                            <div class="col-md-3 form-control-fld">
                                                <div class="input-prepend">
                                                    ...
                                                    {!! Form::text('lr_no', '', ['id' => 'lr_no','class'=>"form-control ", 'placeholder' => 'AWB Number*']) !!}
                                                </div>
                                            </div>
