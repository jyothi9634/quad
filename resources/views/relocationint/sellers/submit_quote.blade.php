...
@else
    <form  id="reloc_submit_quote_{{$id}}" name="reloc_submit_quote_{{$id}}" class="relocationoffice_submit_quote" method="get">
		...
		<input type="text" id="od_charges_{{$id}}" name="od_charges_{{$id}}" class="form-control form-control1 clsRIOSODChargesFlat relocationoffice_submit_quote"  placeholder="O & D Charges (Flat)" />
		</div>
        <div class="col-md-3 padding-left-none">
		<input type="text" id="freight_charges_{{$id}}" name="freight_charges_{{$id}}" class="form-control form-control1 clsRIOSFreightFlat relocationoffice_submit_quote" placeholder="Freight Charges (Flat)" />
		</div>
        <div class="col-md-3 padding-left-none">
			<input type="text" id="transit_days_{{$id}}" name="transit_days_{{$id}}" class="form-control form-control1 clsRIOSNoOfItems relocationoffice_submit_quote" maxlength="3" placeholder="Transit Days" />
		</div>
		<div class="clearfix"></div>
        ...
        <div class="clearfix"></div>
        <div class="col-md-3 padding-left-none">
		<input type="text" id="cancellation_charges_{{$id}}" name="cancellation_charges_{{$id}}" class="form-control form-control1 clsRIOSCancelCharges" placeholder="Cancellation Charges" />
		</div>
        <div class='clearfix'></div>
