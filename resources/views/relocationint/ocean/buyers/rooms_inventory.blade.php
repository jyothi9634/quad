	...
	@foreach($roomtypes as $roomtype)
			<div class="table-row inner-block-bg checkbox-alignment">
				...
				<div class="col-md-2 padding-left-none">
					<input type="text" name="roomitems_{{$roomtype->id}}" id="roomitems_{{$roomtype->id}}" class="form-control form-control1 roomitems clsRIOSNoOfItems" value="{{ $masterbedroom[$masterid] }}" onblur="javascript:valuecheck(this.value,this.id)">
				...
				@else
				 <div class="col-md-2 padding-left-none">
					<input type="text" name="roomitems_{{$roomtype->id}}" id="roomitems_{{$roomtype->id}}" class="form-control form-control1 roomitems clsRIOSNoOfItems" onblur="javascript:valuecheck(this.value,this.id)">
