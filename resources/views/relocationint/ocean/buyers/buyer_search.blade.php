...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		...
		{!! Form::text('from_location_intre',  (Session::has('session_from_location_buyer'))?Session::get('session_from_location_buyer'):'', ['id' => 'from_location_intre','class' => 'form-control', 'placeholder' => 'From Location (Only Major Cities) *']) !!}
        {!! Form::hidden('from_location_id_intre', (Session::has('session_from_city_id_buyer'))?Session::get('session_from_city_id_buyer'):'', array('id' => 'from_location_id_intre')) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		<span class="add-on"><i class="fa fa-map-marker"></i></span>
		{!! Form::text('to_location_intre',(Session::has('session_to_location_buyer'))?Session::get('session_to_location_buyer'):'', ['id' => 'to_location_intre','class' => 'form-control', 'placeholder' => 'To Location (Only Major Cities) *']) !!}
        {!! Form::hidden('to_location_id_intre', (Session::has('session_to_city_id_buyer'))?Session::get('session_to_city_id_buyer'):'', array('id' => 'to_location_id_intre')) !!}
	</div>
</div>
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		...
		{!! Form::text('valid_from', (Session::has('session_dispatch_date_buyer'))?Session::get('session_dispatch_date_buyer'):'', ['id' => 'ptlDispatchDate','class' => 'calendar form-control from-date-control','readonly' => true, 'placeholder' => 'Dispatch Date*']) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		<span class="add-on"><i class="fa fa-calendar-o"></i></span>
		{!! Form::text('valid_to', (Session::has('session_delivery_date_buyer'))?Session::get('session_delivery_date_buyer'):'', ['id' => 'ptlDeliveryhDate','class' => 'calendar form-control to-date-control','readonly' => true, 'placeholder' => 'Delivery Date']) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		...
		{!!	Form::select('property_type',(['' => 'Property Type *'] +$property_types), (Session::has('session_delivery_date_buyer'))?Session::get('session_property_type_buyer'):'' ,['class' =>'selectpicker','id'=>'property_type']) !!}
	</div>
</div>

<div class="clearfix"></div>

@if(Session::has('session_chkOrgServ') && Session::get('session_chkOrgServ') == 1)
{{-- */  $chkOrgServ='checked';  /* --}}
@else
{{-- */ $chkOrgServ=''; /* --}}
@endif

@if(Session::has('session_origin_handy_serivce') && Session::get('session_origin_handy_serivce') == 1)
{{-- */  $origin_handy_serivce='checked';  /* --}}
@else
{{-- */ $origin_handy_serivce=''; /* --}}
@endif

@if(Session::has('session_insurance_serivce') && Session::get('session_insurance_serivce') == 1)
{{-- */  $insurance_serivce='checked';  /* --}}
@else
{{-- */ $insurance_serivce=''; /* --}}
@endif

@if(Session::has('session_destination_storage_serivce') && Session::get('session_destination_storage_serivce') == 1)
{{-- */  $destination_storage_serivce='checked';  /* --}}
@else
{{-- */ $destination_storage_serivce=''; /* --}}
@endif

@if(Session::has('session_destination_handy_serivce') && Session::get('session_destination_handy_serivce') == 1)
