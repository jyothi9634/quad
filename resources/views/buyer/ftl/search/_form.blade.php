...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		...
		{!! Form::text('from_location', request('from_location'), ['id' => 'from_location', 'class'=>'form-control clsFTLFromLocation','placeholder' => 'From Location *']) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		<span class="add-on"><i class="fa fa-map-marker"></i></span>
		{!! Form::text('to_location', request('to_location'), ['id' => 'to_location', 'class'=>'form-control clsFTLtoLocation', 'placeholder' => 'To Location *']) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		<span class="add-on"><i class="fa fa-calendar-o"></i></span>
		{!! Form::text('to_date', request('to_date'), ['id' => 'delivery_date1','class' => 'calendar form-control to-date-control', 'placeholder' => 'Delivery Date','readonly'=>"readonly"]) !!}
...
<div class="col-md-4 form-control-fld">
	<div class="input-prepend">
		...
		{!!	Form::select('lkp_load_type_id',(['' => 'Select Load Type *'] +$load_type ), request('lkp_load_type_id'),['class' =>'selectpicker form_control','id'=>'load_type','onChange'=>'return GetCapacity()']) !!}
	</div>
</div>
...
<div class="col-md-4 form-control-fld">
		...
		{!! Form::text('quantity', request('quantity'), ['id' => 'quantity','search'=>'1', 'class'=>'form-control clsFTLQuantity','placeholder' => 'Qty *']) !!}
...
<div class="col-md-6 form-control-fld">
	<img src="images/truck.png" class="truck-type" /> 
