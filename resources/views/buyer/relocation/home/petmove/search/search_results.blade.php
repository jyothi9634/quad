			...
			<h1 class="page-title">Search Results (Relocation Pet)</h1><a href="#" class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a>
				...
				<div class="col-md-12 padding-none">
					<div class="main-inner"> 
                        ...
                        {!! Form::hidden('from_location_id', $request['from_location_id'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('to_location_id', $request['to_location_id'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('from_location', $request['from_location'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('to_location', $request['to_location'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('from_date', $request['from_date'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('to_date', $request['to_date'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('selPettype', $request['selPettype'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('selBreedtype', $request['selBreedtype'],array('class'=>'form-control')) !!}
                        {!! Form::hidden('selCageType', $request['selCageType'],array('class'=>'form-control')) !!}
