				...
				<div class="col-md-12 padding-none">
					<div class="main-inner"> 
						...
						{!! Form::open(['url' =>'#','id' => 'buyer_results_form','class'=>'filter_form','method'=>'get']) !!}
                                                ...
                                                {!! Form::hidden('to_location_id', Session::get('session_to_city_id_buyer')) !!}
                                                {!! Form::hidden('to_location', Session::get('session_to_location_buyer')) !!}		
                                                {!! Form::hidden('from_date', Session::get('session_dispatch_date_buyer')) !!}                		
                                                {!! Form::hidden('relgm_service_type', Session::get('session_service_type_relocation')) !!}
                                                {!! Form::hidden('measurement', Session::get('session_measurement_relocation')) !!}
