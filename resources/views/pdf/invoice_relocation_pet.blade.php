        ...
        <table cellspacing="0" cellpadding="0" width="500" style="margin: auto;">
            <tr>
                <td colspan="2" style="padding: 10px 25px;">
                    <h4 style="font-size: 17px; font-weight: 500; margin: 10px 0; text-align: center">Proforma Invoice for RELOCATION PET</h4>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="width: 50%; padding: 10px 25px;">
                    ...
                    <textarea type="text" placeholder="Vendor Address" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">@if($roleId == 2) Cost wise @else {{ $invoiceData[0]->name }} @endif <br>Hyderabad</textarea>
                </td>
