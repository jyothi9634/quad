        ...
        <table cellspacing="0" cellpadding="0" width="500" style="margin: auto;">
            <tr>
                <td colspan="2" style="padding: 10px 25px;">
                    <h4 style="font-size: 17px; font-weight: 500; margin: 10px 0; text-align: center">Proforma Invoice for RELOCATION INTERNATIONAL</h4>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2" style="padding: 10px 25px 5px;">
                    <b>Road - RELOCATION INTERNATIONAL</b>
