        ...
        <table cellspacing="0" cellpadding="0" width="500" style="margin: auto;">
            <tr>
                <td colspan="2" style="padding: 10px 25px;">
                    <h4 style="font-size: 17px; font-weight: 500; margin: 10px 0; text-align: center">Proforma Invoice for {{$service_title}}</h4>
                </td>
            </tr>
            <tr>
                ...
                <td style="width: 50%; padding: 10px 25px;">
                    ...
                    <input type="text" placeholder="Invoice Number" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;" value="{{ $invoiceData[0]->invoice_no }}"/>
                </td>
            </tr>
            <tr>
                <td style="width: 50%; padding: 10px 25px;">
                    <label style="display: block; clear: both">Vendor Address</label>
                    <textarea type="text" placeholder="Vendor Address" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">@if($roleId == 2) Cost wise <br>Hyderabad @else {{ $invoiceData[0]->name }} <br> {{ $invoiceData[0]->address }} @endif</textarea>
                </td>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            <td style="padding: 5px 25px; width: 50%;">
                                ...
                                <textarea type="text" placeholder="Billing Address (As Specified by Buyer)" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">{{ $invoiceData[0]->address }}</textarea>   
                            </td>
                            <td style="padding: 5px 25px; width: 50%;">
                                <label style="display: block; clear: both">Shipping Address</label>
                                @if($roleId == BUYER)
                                <textarea type="text" placeholder="Shipping Address" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">@if(isset($invoiceData[0]->buyer_consignee_address) && $invoiceData[0]->buyer_consignee_address) {{ $invoiceData[0]->buyer_consignee_address }} @else NA @endif </textarea> 
            ...
            <tr>
                <td colspan="2" style="padding: 10px 25px 5px;">
                    <b>Road - {{$service_title}}</b>
                    <div style="display: block; height: 10px;"></div>
                    @if(isset($invoiceData[0]->city_from) && $invoiceData[0]->city_from)
                    <span>From : </span> <b>{{ $invoiceData[0]->city_from }}</b>
                    @endif
                    @if(isset($invoiceData[0]->city_to) && $invoiceData[0]->city_to) &nbsp;&nbsp; 
                    <span>To : </span> <b>{{ $invoiceData[0]->city_to }}</b>@endif
                </td>
            </tr>
            <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="500" style="margin: 0 auto 25px;">
                        @if($serviceId == ROAD_FTL)
                            ...
                            <tr>
                                ...
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->quantity }}</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                        ...
                        @elseif ($serviceId == ROAD_PTL)
                            <tr>
                                ...
                                <td style="width: 33.333%;  padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold">Package Type</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold;">Unit Weight </label>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                ...
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->packaging_type_name }}</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500; ">
                                        {{ $invoiceData[0]->units }}
                                        {{ $commonComponent->getWeight($invoiceData[0]->lkp_ptl_length_uom_id) }}
                                    </label>
                                </td>
                            </tr>
                        ...
                        @elseif ($serviceId == COURIER)
                            <tr>
                                <td style="width: 33.333%;  padding: 10px;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold">Courier Type</label>
                                </td>
                                <td style="width: 33.333%;  padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold">Delivery Type</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold;">Unit Weight </label>
                                </td>                            
                            ...
                            <tr>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->courier_type }}</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->courier_delivery_type }}</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500; ">
                                        {{ $invoiceData[0]->units }}
                                        {{ $commonComponent->getWeight($invoiceData[0]->lkp_ict_weight_uom_id) }}
                                    </label>
                                </td>                            
                            </tr>
                        ...
                        @elseif ($serviceId == RELOCATION_PET_MOVE)
                            <tr>
                                <td style="width: 33.333%;  padding: 10px;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold">Pet Type</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold;">Breed</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold;">Cage Type</label>
                                </td> 
                                <td style="width: 33.333%; padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold;">Cage Weight</label>
                                </td> 
                            </tr>                        
                            <tr>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->pet_type }}</label>
                                </td>
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500">{{ $invoiceData[0]->breed_type }}</label>
                                </td>
                                
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500; ">{{ $invoiceData[0]->cage_type }}</label>
                                </td> 
                                <td style="width: 33.333%; padding: 10px;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: 500; ">{{ $invoiceData[0]->cage_weight }} KGs</label>
                                </td> 
                            </tr>
                        ...
                        @elseif ($serviceId == RELOCATION_GLOBAL_MOBILITY)
                            <tr>
                                ...
                                <td style="width: 33.333%;  padding: 10px;;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;">
                                    <label style="font-weight: bold">Numbers</label>
                                </td>
                            </tr>     
                        ...
                        <tr>
                            <td colspan="4" style="width: 33.333%;padding: 1px 10px;border-bottom: 1px solid #eeeeee; text-align:right">
                                @if(!SHOW_SERVICE_TAX)
