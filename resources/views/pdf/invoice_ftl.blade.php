        ...
        <table cellspacing="0" cellpadding="0" width="500" style="margin: auto;">
            <tr>
                <td colspan="2" style="padding: 10px 25px;">
                    <h4 style="font-size: 17px; font-weight: 500; margin: 10px 0; text-align: center">Proforma Invoice for FTL</h4>
                </td>
            </tr>
            <tr>
                    ...
                    <table cellspacing="0" cellpadding="0" width="100%">
                        <tr>
                            ...
                            <td style="padding: 5px 25px; width: 50%;">
                                ...
                                @if($roleId == BUYER)
                                <textarea type="text" placeholder="Shipping Address" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">{{ $invoiceData[0]->buyer_consignee_address }}</textarea> 
                                @elseif($roleId == SELLER)
                                <textarea type="text" placeholder="Shipping Address" style="border: 1px solid #cecece;border-radius: 4px;font-size: 12px;padding: 7px 5px; margin: 3px 0; width: 100%;font-family: 'Arial';">NA</textarea> 
                                @endif
                            </td>
                        </tr>
                    </table>
