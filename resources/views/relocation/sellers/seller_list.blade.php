...
@include('partials.page_top_navigation')
	...
	<div class="main">
		...
		@endif
			<div class="container">
				<span class="pull-left"><h1 class="page-title">Posts (Relocation)</h1><a class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>			
					...
					<div class="main-inner"> 	
						...
						<div class="main-right">
					 		...
					 		{!! $filter->field('src') !!} 		
								<div class="col-md-12 padding-none filter">										
								   ...
								   <div class="col-md-3 form-control-fld">
									...
									<div class="col-md-3 form-control-fld">
											<div class="normal-select">
												<select class="selectpicker" name="post_for" id="post_for" onchange="return this.form.submit()">
													<option value="">Post For</option>
													<option value="1" <?php if (isset($_REQUEST['post_for']) && $_REQUEST['post_for']=="1") echo ' selected';?>>HHG</option>
													<option value="2" <?php if (isset($_REQUEST['post_for']) && $_REQUEST['post_for']=="2") echo ' selected';?>>Vehicle</option>
													<option value="3" <?php if (isset($_REQUEST['post_for']) && $_REQUEST['post_for']=="3") echo ' selected';?>>Both</option>
												</select>
											</div>
										</div>										
									</div>
                            ...
                            @endif
								...
								<input type="hidden" name="service_type" id="service_type" value="1">
								  <input type="hidden" name="status"  value="<?php if(isset ( $_REQUEST ['status'] )) echo  $_REQUEST['status']; ?>">
							{!! $filter->close !!} 
							@endif
							</div>
