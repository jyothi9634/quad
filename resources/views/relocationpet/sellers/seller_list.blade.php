		...
		@endif
			<div class="container">
				<span class="pull-left"><h1 class="page-title">Posts (Relocation Pet)</h1><a class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>			
					<a onclick="return checkSession(17,'/relocation/createsellerpost');" href="#"><button class="btn post-btn pull-right">+ Post</button></a>
						...
						<div class="main-right">
							...
							<div class="gray-bg">
										...
										{!! $filter->field('rbp.to_location_id') !!}
											...
											<div class="input-prepend">
												<span class="add-on"><i class="fa fa-link"></i></span>												
                                                                                                {!! $filter->field('rbp.lkp_cage_type_id') !!}
											</div>
										</div>
										<div class="col-md-3 form-control-fld">
											<div class="input-prepend">
												<span class="add-on"><i class="fa fa-paw"></i></span>												
                                                                                               {!! $filter->field('rbp.lkp_pet_type_id') !!}
											</div>
										</div>
									...
									<input type="hidden" name="post_type"  value="2">
                                                                        <input type="hidden" name="status"  value="<?php (isset ( $_REQUEST ['status'] ))? $_REQUEST['status'] : "" ?>">
									{!! $filter->close !!}
										...
										<div class="col-md-3 form-control-fld">
											<div class="input-prepend">
					                            ...
					                            @endif
                                                        ...
                                                        <?php //print_r($_REQUEST['post_type']);?>
                                                                        <input type="hidden" name="post_type"  value="<?php if(isset ( $_REQUEST ['post_type'] )) echo  $_REQUEST['post_type']; ?>">
