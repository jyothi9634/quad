...
<!--             </span> -->
                     ...
                     <div class="search-block inner-block-bg margin-bottom-less-1">
                        ...
                        <div>
                            ...
                            <span class="search-result" data-price="{!! $_REQUEST['price'] !!}" id="ptl_buyer_leads_post_price_{!! $buyerQuoteForLeadId !!}">
                                ...
                                @if(isset($_REQUEST['price'])){{$commonComponent->number_format($_REQUEST['price'])}}@endif
                            </span>
                        </div>
                    ...
                    @if($buyerQuoteId == $buyerQuoteSellerPriceId)
                        ...
                        <div class="search-block inner-block-bg margin-bottom-less-1">
                            ...
                            <div>
                                <p class="search-head">Transit Time</p>
                                <span class="search-result">
                                    {!! $buyerQuoteSellersQuotesDetails->initial_transit_days !!} {!! $buyerQuoteSellersQuotesDetails->units !!}
                                </span>
                            </div>
                            <div>
                                <p class="search-head">Price</p>
                        ...
                        {!! Form::hidden('ptl_buyer_counter_offer_seller_post_from_date_'.$buyerQuoteId, 
                                        $exactDispatchDate, array('id' =>'ptl_buyer_counter_offer_seller_post_from_date_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_counter_offer_seller_post_to_date_'.$buyerQuoteId, 
                                        $exactDeliveryDate, array('id' =>'ptl_buyer_counter_offer_seller_post_to_date_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_counter_offer_seller_from_date_'.$buyerQuoteId,
                                            $sellerpost->from_date, array('id' =>'ptl_buyer_counter_offer_seller_from_date_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_counter_offer_seller_to_date_'.$buyerQuoteId,
                                            $sellerpost->to_date, array('id' =>'ptl_buyer_counter_offer_seller_to_date_'.$buyerQuoteId)) !!}

                        {!! Form::hidden('fdispatch-date_'.$buyerQuoteId,
                                            $Dispatch_Date, array('id' =>'fdispatch-date_'.$buyerQuoteId, 'class'=>'flexyDispatch')) !!}
    					{!! Form::hidden('ptl_buyer_post_buyer_id_'.$buyerQuoteId, $buyerQuoteSellersQuotesDetails->buyer_id, array('id' => 'ptl_buyer_post_buyer_id_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_post_seller_id_'.$buyerQuoteId, $buyerQuoteSellersQuotesDetails->seller_id, array('id' => 'ptl_buyer_post_seller_id_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_quote_item_id_'.$buyerQuoteId, $buyerQuoteSellersQuotesDetails->buyer_quote_item_id, array('id' => 'ptl_buyer_quote_item_id_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_buyer_quote_id_'.$buyerQuoteId, $buyerQuoteSellersQuotesDetails->buyerQuoteId, array('id' => 'ptl_buyer_quote_id_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_seller_post_item_id_'.$buyerQuoteId, $buyerQuoteSellersQuotesDetails->seller_post_item_id, array('id' => 'ptl_seller_post_item_id_'.$buyerQuoteId)) !!}
                        {!! Form::hidden('ptl_cancel_buyer_counter_offer_enquiry', $id, array('id' => 'ptl_cancel_buyer_counter_offer_enquiry','data-id'=>$id)) !!}
            ...
            @endif
            <!-- Search Block Ends Here -->
            @if($routeName=='buyerbooknowforleads')
            {{--*/ $formid = 'ltl-buyer-leads-booknow' /*--}}
            @else
            {{--*/ $formid = 'addptlbuyerpostcounteroffer' /*--}}
            @endif
            ...
            <div class="col-md-12 padding-none">
                <div class="main-inner"> 
                    ...
                    <div class="main-right">
                        ...
                        {!! Form::open(array('url' => '#', 'id' => $formid, 'name' => $formid)) !!}
