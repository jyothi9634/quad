                    ...
                    <div class="search-block inner-block-bg margin-bottom-less-1">
                        <div class="from-to-area">
                            <span class="search-result">
                                ...
                                <span class="location-text" id="fromtolocations">{!! $fromCity !!} to {!! $toCity !!}</span>
                            </span>
                        </div>
                        <div class="date-area">
                        ...
                        <div class="search-block inner-block-bg margin-bottom-less-1">
                            ...
                            <div>
                                ...
                                {!! Form::hidden('buyer_leads_price'.$buyerQuoteForLeadId,
                                                $price, array('id' =>'buyer_leads_price'.$buyerQuoteForLeadId)) !!}
                ...
                <div class="col-md-12 padding-none">
                    <div class="main-inner"> 
                        ...
                        <div class="main-right">
                            ...
                            {!! Form::open(array('url' => '#', 'id' => 'ftl-buyer-leads-booknow', 'name' => 'ftl-buyer-leads-booknow')) !!}
