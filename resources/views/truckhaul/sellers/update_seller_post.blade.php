...
<div class="main">
	<div class="container">
		...
		<span class="pull-left"><h1 class="page-title">Edit Post (TRUCK HAUL)</h1><a class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>
		...
		<div class="col-md-12 inner-block-bg single-layout padding-none">
			...
			{!! Form::open(['url' => 'updateseller/'.$seller_post_edit->id,'id'=>'truckhaul-posts-form-lines']) !!}	
					...
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
							<span class="add-on"><i class="fa fa-calendar-o"></i></span>
							{!! Form::text('valid_to',\App\Components\CommonComponent::convertDateDisplay($seller_post_edit->to_date), ['id' => 'datepicker_to_location','class' => 'calendar form-control to-date-control clsTHValidTo','readonly'=>true, 'placeholder' => 'Valid To*']) !!}
						</div>
					</div>
					...
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
							...
							{!! Form::select('LoadTypeMasters', (['' => 'Select Load Type*'] + $loadtypemasters), null, ['class' => 'selectpicker form-control','id' => 'load_type']) !!}
						</div>
					</div>
					...
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
							<span class="add-on"><i class="fa fa-truck"></i></span>
							{!! Form::text('vehicle_number','',['class'=>'form-control clsVehicleno','id'=>'vehicle_number','placeholder'=>'Vehicle Number*']) !!}
						</div>
					</div>
					...
					<div class="col-md-3 padding-none">
						...
						<div class="col-md-12 form-control-fld padding-left-none">
							...
							{!! Form::text('price','',['class'=>'form-control clsTHRate','id'=>'price','placeholder'=>'Rate*']) !!}
					...
					<div class="col-md-3 form-control-fld padding-left-none">
						<input type="button" id="add_more_update_th" value="Update" class="btn add-btn" style="display:none;">
					</div>
					{!! Form::close() !!}
			</div>
							...
							<div id ="multi-line-itemes">
								...
								@foreach($seller_post_edit_action_lines as $key=>$seller_post_edit_action_line)
									<div class="table-row inner-block-bg request_row_{!! $seller_post_edit_action_line->id !!}" id="single_post_item_{!! $seller_post_edit_action_line->id !!}">
										...
										<div class="col-md-2 padding-left-none load_type_text hidden-xs">{!! $seller_post_edit_action_line->load_type !!}</div>
										<div class="col-md-2 padding-left-none vehicle_type_text hidden-xs">{!! $seller_post_edit_action_line->vehicle_type !!}</div>
										<div class="col-md-2 padding-left-none vehicle_number hidden-xs">{!! $seller_post_edit_action_line->vehicle_number !!}</div>
										...
										<input type="hidden" value="{!! $seller_post_edit_action_line->vehicle_number !!}" name="vehicle_number[]">
...
<div class="col-md-12 inner-block-bg inner-block-bg1">
			...
			<div class="my-form">
				<div class="form-control-fld terms-and-conditions-block">
					<div class="col-md-3 padding-none tc-block-fld">
						{!! Form::text('terms_condtion_types1',$seller_post_edit->cancellation_charge_price,['class'=>'form-control form-control1 update_txt clsTHCancelCharges', 'placeholder' => 'Cancellation Charges']) !!}
					</div>
			...
			<div class="my-form">
				<div class="text-box form-control-fld terms-and-conditions-block">
					<div class="col-md-3 padding-none tc-block-fld">
						{!! Form::text('terms_condtion_types2',$seller_post_edit->docket_charge_price,['class'=>'form-control form-control1 update_txt clsTHOtherCharges', 'placeholder' => 'Other Charges']) !!}
					</div>
