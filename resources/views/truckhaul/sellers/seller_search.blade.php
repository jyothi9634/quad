							...
							<div class="col-md-12 padding-none">
								<div class="col-md-4 form-control-fld">
									<div class="input-prepend">
										...
										{!! Form::text('from_location', Session::get('session_from_location'), ['id' => 'from_location','class' => 'top-text-fld form-control', 'placeholder' => 'From Location*']) !!}
								...
								<div class="col-md-4 form-control-fld">
									<div class="input-prepend">
										<span class="add-on"><i class="fa fa-map-marker"></i></span>
										{!! Form::text('to_location', Session::get('session_to_location'), ['id' => 'to_location','class' => 'top-text-fld form-control', 'placeholder' => 'To Location*']) !!}
								...
								<div>
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											...
											{!! Form::text('dispatch_date', Session::get('dispatch_date'), ['id' => 'datepicker_search','class' => 'form-control calendar from-date-control','readonly'=>true, 'placeholder' => 'Reporting Date*']) !!}
									...
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											...
											@endif
											{!!	Form::hidden('capacity',Session::get('session_capacity'),array('class'=>'form-control','id'=>'capacity','placeholder'=>'Capacity','readonly')) !!}
																					
									<div class="col-md-4 form-control-fld">
										<div class="input-prepend">
											<span class="add-on"><i class="fa fa-archive"></i></span>
                                                                                        @if(Session::get('session_qty')!='')
											{!! Form::select('lkp_vehicle_type_id', (['20'=>'Vehicle Type (Any)'] + $vehicletypemasters ), Session::get('session_vehicle_type'), ['class' => 'selectpicker','id' => 'vechile_types']) !!}
                                                                                        @else
                                                                                        {!! Form::select('lkp_vehicle_type_id', (['20'=>'Vehicle Type (Any)'] + $vehicletypemasters ), Session::get('session_vehicle_type'), ['class' => 'selectpicker','id' => 'vechile_types']) !!}
                                                                                        @endif
										</div>
