...
<div class="main">
	...
	<div class="container">
		<span class="pull-left"><h1 class="page-title">Post & Get Quote (Haul)</h1><a href="#" class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>
	...
	<div class="showhide_spot" id="showhide_spot"><!-- Add custom div for FTl spot srinu -->
		<div class="col-md-12 inner-block-bg single-layout padding-none">
			...
			{!! Form::open(['url' =>'#','id' => 'buyer_truckhaul_quotelineitems_form_validation' , 'autocomplete'=>'off']) !!}
				<div class="col-md-12 form-control-fld margin-none">
				...
				<div class="col-md-12 padding-none inner-form">					
					...
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
							...
							{!! Form::text('reporting_date', $session_search_values_create[1], ['id' => 'reporting_date','class' => 'form-control calendar_new_report from-date-control clsTHReportingDate', 'placeholder' => 'Reporting Date *','readonly'=>"readonly"]) !!}
							<input type="hidden" name="is_reporting_flexible_hidden" id="is_reporting_flexible_hidden" value="0">
						</div>
					</div>
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
					...
					<div class="col-md-3 form-control-fld">
						<div class="input-prepend">
							{!!	Form::text('c',$session_search_values_create[8],array('class'=>'form-control form-control1 clsTHQuantity','placeholder'=>'Quantity *','id'=>'quantity')) !!}
					...
					<div class="col-md-2 form-control-fld" id="hide_price">
						<div class="input-prepend" >
							<span class="add-on"><i class="fa fa-rupee "></i></span>
								{!!	Form::text('price',null,array('class'=>'form-control clsTHPrice','placeholder'=>'Price *','id'=>'price','autocomplete'=>'off')) !!}
						</div>
					</div>
					<div class="col-md-3 form-control-fld">
						<div>
					...
					<div class="col-md-3 form-control-fld text-right pull-right">
							<input type="submit" value="Add +" class="btn add-btn" id="add_th_buyer_more">
			...
			{!!	Form::hidden('lead_type','1',array('id'=>'lead_type')) !!}
			{!!	Form::hidden('no_of_loads','1',array('class'=>'form-control form-control1 numericvalidation','placeholder'=>'Loads','id'=>'no_of_loads')) !!}
			{!! Form::open(['url' =>'truckhaul/createbuyerquote','id' => 'buyer_quote_form']) !!}
				...
				<div class="col-md-12 inner-block-bg inner-block-bg1 border-top-none border-bottom-none margin-bottom-none padding-bottom-none padding-top-none">
					...
					{!!	Form::hidden('update_term_row_unique','',array('class'=>'','id'=>'update_term_row_unique'))!!}
	                    	<div class="col-md-3 form-control-fld">
								<div class="input-prepend">
									<span class="add-on"><i class="fa fa-calendar-o"></i></span>									
									{!! Form::text('term_dispatch_date', '', ['id' => 'term_dispatch_date','class' => 'form-control calendar', 'placeholder' => 'Valid From *','readonly'=>"readonly"]) !!}
								</div>
							</div>
							<div class="col-md-3 form-control-fld">
								<div class="input-prepend">
									<span class="add-on"><i class="fa fa-calendar-o"></i></span>
									{!! Form::text('term_delivery_date', '', ['id' => 'term_delivery_date','class' => 'form-control calendar', 'placeholder' => 'Valid To *','readonly'=>"readonly"]) !!}
								</div>
							</div>
						...
						<div class="col-md-3 form-control-fld">
	                        ...
	                        <div class="col-md-3 form-control-fld">
									...
									{!!	Form::text('term_quantity','',array('class'=>'form-control numberVal','placeholder'=>'Quantity *','id'=>'term_quantity')) !!}
									<span class="add-on unit1">
					...
					<div class="col-md-12 padding-left-none padding-right-none pad-top-20">
						   ...
						   <div class="col-md-3 form-control-fld">
								<div class="input-prepend"> 
									{!! Form::text('bid_close_time', '', ['id' => 'bid_close_time','class' => 'form-control form-control1 clock timepicker', 'placeholder' => 'Bid Closure Time *', 'readonly'=>"readonly"]) !!}	
								</div>
							</div>							
							<div class="clearfix"></div>
...
<!-- 	                			<input type="text" class="form-control form-control1 upload-control" readonly>  -->
					...
					<div class="col-md-9 form-control-fld">								
							<textarea  class="form-control form-control1" name="buyer_notes" id="buyer_notes"></textarea>	
					</div>	
					...
					<div class="col-md-12 inner-block-bg inner-block-bg1">
						...
						<div class="check-box form-control-fld">
							<div class="normal-checkbox">
							  {!! Form::checkbox('agree', 1, false, ['class' => 'field','id'=>'agree']) !!} <span class="lbl padding-8">Accept Terms & Conditions (Digital Contract)</span></div>
							</div>
						</div>
