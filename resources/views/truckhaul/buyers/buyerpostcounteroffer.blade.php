                                                                ...
                                                                @if($buyerQuoteSellersQuotesDetails->firm_price == '0.0000')
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        {!! Form::text('buyer_post_counter_offer_'.$buyerQuoteId,'',
                                                                                    array('id'=>'buyer_post_counter_offer_'.$buyerQuoteId,'placeholder'=>'Counter Offer', 'class'=>'form-control form-control1 buyer_post_counter_offer_value numberVal fivedigitstwodecimals_deciVal')) !!}
