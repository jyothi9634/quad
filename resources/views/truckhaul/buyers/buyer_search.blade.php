					...
					<div class="col-md-12 padding-none">
						...
						<div class="col-md-4 form-control-fld">
							<div class="input-prepend">
								...
								{!! Form::text('from_location', '', ['id' => 'from_location', 'class'=>'form-control clsTHFromLocation','placeholder' => 'From Location *']) !!}
						...
						<div class="col-md-4 form-control-fld">
							<div class="input-prepend">
								<span class="add-on"><i class="fa fa-map-marker"></i></span>
								{!! Form::text('to_location', '', ['id' => 'to_location', 'class'=>'form-control clsTHToLocation', 'placeholder' => 'To Location *']) !!}
							...
							<div class="col-md-4 form-control-fld">
								<div class="input-prepend">
									...
									{!! Form::text('from_date', '', ['id' => 'dispatch_date1','class' => 'calendar form-control from-date-control clsTHReportingDate', 'placeholder' => 'Reporting Date *','readonly'=>"readonly"]) !!}
							...
							<div class="col-md-4 form-control-fld">
								<div class="input-prepend">
									...
									{!!	Form::select('lkp_load_type_id',(['11'=>'Load Type (Any)'] +$load_type ), null,['class' =>'selectpicker form_control','id'=>'load_type','onChange'=>'return GetCapacity()']) !!}
								</div>
							</div>
							<div class="col-md-4 form-control-fld">
								<div class="input-prepend">
									<span class="add-on"><i class="fa fa-balance-scale"></i></span>
									<input type="text" placeholder="Qty *" class="form-control clsTHQuantity" name="quantity" id="quantity">
