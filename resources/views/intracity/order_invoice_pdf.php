	...
	<div class="main-container">	
		<div class="container container-inner">
			<div class="col-lg-12 col-md-12 col-sm-10 col-xs-12 main-middle">
				<h4><b>Invoice for Intracity</b></h4>	
				<br>
		            ...
		            <div class="table-data">
						...
						<div class="col-md-12 col-sm-12 col-xs-12 padding-none">
		                		...
		                		<div width="100%" class="table table-head">
									<div class="col-md-4 col-sm-4 col-xs-4 padding-none">City</div>
									<div class="col-md-4 col-sm-4 col-xs-4 padding-none">Load Type</div>
									<div class="col-md-4 col-sm-4 col-xs-4 padding-none">Vehicle Type</div>
									<div class="clearfix"></div>
								</div>
					            <div class="table-data">
					                <div class="col-md-12 col-sm-12 col-xs-12 padding-left-none padding-none table-row">
					                	<div class="clearfix"></div>
					                	<div class="col-md-4 col-sm-4 col-xs-4 padding-none">Value</div>
										<div class="col-md-4 col-sm-4 col-xs-4 padding-none">Value</div>
										<div class="col-md-4 col-sm-4 col-xs-4 padding-none">Value</div>
										<div class="clearfix"></div>
									</div>
