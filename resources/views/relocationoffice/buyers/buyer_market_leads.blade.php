...
<div class="main">
	<div class="container">
		...
		<span class="pull-left"><h1 class="page-title">Posts (Relocation Office)</h1><a class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>
								...
								<div class="gray-bg">
									...
									<div class="col-md-3 form-control-fld">
										...
										<select name="status_id" id="status_id" class="selectpicker">
												...
												<option <?php if (isset ( $post_status ) && $post_status == 2) { ?> selected="selected" value="2" <?php } else { ?>value="2"<?php } ?> >Open</option>
												<option <?php if (isset ( $post_status ) && $post_status == 5) { ?> selected="selected" value="5" <?php } else { ?>value="5"<?php } ?> >Deleted</option>
												<option <?php if (isset ( $post_status ) && $post_status == 3) { ?> selected="selected" value="3" <?php } else { ?>value="3"<?php } ?> >Closed</option>
											</select>	
										</div>
									</div>
