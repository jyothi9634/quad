				...
				<div class="search-block inner-block-bg">
					<div class="from-to-area">
						<span class="search-result">
							...
							<span class="location-text">{!! $fromCity !!} @if($toCity) to {!! $toCity !!} @endif</span>
						</span>
					</div>
					<div class="date-area">
...
<!--								15 Jul 2015-->{!! Session::get('session_dispatch_date_buyer_office') !!}
							</span>
						</div>
						<div class="col-md-6 padding-none">
							...
							<span class="search-result">
								<i class="fa fa-calendar-o"></i>
                                @if(Session::get('session_delivery_date_buyer_office') == "0000-00-00" || Session::get('session_delivery_date_buyer_office') == "" )
                                    N / A
                                @else
                                  {!! Session::get('session_delivery_date_buyer_office') !!}
                                @endif
					...
					<div>
						...
						<span class="search-result">{{ Session::get('session_volume_buyer_office') }}</span>
					</div>
                        ...
                        <div class="search-block inner-block-bg">
                            ...
                            <div>
                                ...
                                <span class="search-result">
                                    ...
                                    {!! $commonComponent->number_format($allInput['buyersearch_booknow_seller_price_'.$id],true) !!}
