...
@section('content')
    ...
    <div class="main">
        ...
        <div class="container">
            ...
            <span class="pull-right"><a onclick="return checkSession(20,'/createseller');" href="#"><button class="btn post-btn pull-right">+ Post</button></a></span>
                    ...
                    <div class="expand-block">
                        <div class="col-md-12">
                            <div class="col-md-2 padding-left-none data-fld">
                                <span class="data-head">Relocation Domestic Post Number</span>
                                        ...
                                        <div class="col-md-12 padding-none">
                                            ...
                                            <div class="col-md-3 form-control-fld">
                                                <div class="input-prepend">
                                                    ...
                                                    {!! Form::text('lr_date', '', ['id' => 'lr_date','class'=>"form-control calendar", 'placeholder' => 'LR Date*','readonly' => true]) !!}
                                                </div>
                                            </div>
                                            <div class="col-md-3 form-control-fld">
                                                <div class="input-prepend">
