...
<div class="main">
	...
	<div class="container">
	 ...
	 @endif 
		...
		{!! Form::open(['url' =>'/userSales','method'=>'POST','id'=>'user_sales']) !!}
				...
				<div class="main-right">
					...
					<div class="table-div">
						...
						<div class="table-heading inner-block-bg">
							...
							<select name="seller_name" id="seller_name" onchange="filterData()" class="selectpicker">
							@foreach($getBuyers as $key=>$value)
							<option value="{{$value->id}}">{{$value->buyer}}</option>		
							@endforeach
							</select>
							</div>
							<!-- <input type="hidden" id="seller_value" name="seller_value" value=""> -->
							</div>
							...
							{!! Form::text('dispatch_date', request('dispatch_date'), ['id' => 'datepicker_search','class' => 'form-control calendar from-date-control','readonly'=>true, 'placeholder' => 'From Date*']) !!}
							</div>
							</div>
							...
							<div class="input-prepend">
							<span class="add-on"><i class="fa fa-calendar-o"></i></span>
							{!! Form::text('dispatch_date', request('dispatch_date'), ['id' => 'datepicker_search','class' => 'form-control calendar from-date-control','readonly'=>true, 'placeholder' => 'To Date*']) !!}
							</div>
							</div>
							...
							<div class="input-prepend">
							<span class="add-on"><i class="fa fa-archive"></i></span>	
							<select name="service_name" id="service_name" onchange="filterData()" class="selectpicker">
							@foreach($getBuyers as $key=>$value)
						...
						<div class="table-heading inner-block-bg">
							<div class="col-md-2 padding-left-none">Name</div>
                            <div class="col-md-2 padding-left-none">Services</div>
						...
						<div class="table-data">
							...
							<div class="table-row inner-block-bg">
								...
								<div class="col-md-2 padding-left-none">{{$value->firstname}}</div>	
								@else
								<div class="col-md-2 padding-left-none">NA</div>	
								@endif
                                <div class="col-md-2 padding-left-none">{{$value->service_name}}</div>
                                <div class="col-md-3 padding-left-none">{{date("Y/m/d",strtotime($value->created_at))}}</div>
								<div class="col-md-4 padding-left-none">{{$value->order_payment_id}}</div>
