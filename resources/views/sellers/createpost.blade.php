...
{{--*/ $serviceId = Session::get('service_id') /*--}}
        <div class="main">
            ...
            <div class="container">
                <span class="pull-left"><h1 class="page-title">Post (FTL)</h1><a class="change-service" data-toggle="modal" data-target="#change-service">Change Service</a></span>
					...
					{!! Form::open(['url' => 'addseller','id'=>'posts-form-lines']) !!}
                            <div class="col-md-3 form-control-fld padding-left-none">
                                <div class="input-prepend">
                                    ...
                                    {!! Form::text('valid_from', $session_search_values_create[1], ['id' => 'datepicker','class' => 'calendar form-control from-date-control','readonly' => true, 'placeholder' => 'Valid From*']) !!}
                                </div>
                            </div>
                            <div class="col-md-3 form-control-fld">
                                <div class="input-prepend">
                                    <span class="add-on"><i class="fa fa-calendar-o"></i></span>
                                    {!! Form::text('valid_to', $session_search_values_create[0], ['id' => 'datepicker_to_location','class' => 'calendar form-control to-date-control','readonly' => true, 'placeholder' => 'Valid To*']) !!}
                                </div>
                            </div>
                            ...
                            <div class="col-md-3 form-control-fld padding-left-none">
                                <div class="col-md-8 padding-none">
                                    <div class="input-prepend">
                                        ...
                                        {!! Form::text('transitdays',null,['class'=>'form-control clsIDtransitdays clsCOURTransitDays','id'=>'transitdays','placeholder'=>'Transit Days*']) !!}
                                ...
                                <div class="col-md-2 form-control-fld">
                                    <div class="input-prepend">
                                        ...
                                        {!! Form::text('price',null,['class'=>'form-control clsFTLRate','id'=>'price','placeholder'=>'Rate*']) !!}
                                    </div>   
                                </div>
                            ...
                            <div class="col-md-6 form-control-fld">
                                <input type="button" id="add_more" value="Add" class="btn add-btn">
                            </div>
            ...
            <div class="col-md-12 inner-block-bg inner-block-bg1">
				...
				<div class="col-md-12 inner-block-bg inner-block-bg1">
                    ...
                    <div class="form-control-fld terms-and-conditions-block">
                        <div class="col-md-3 padding-none tc-block-fld">
                            <div class="input-prepend">
                                <input type="text" name="terms_condtion_types1"  class="form-control form-control1 clsFTLCancelCharges"  placeholder ='Cancellation Charges' id="cancellation1" />
                    ...
                    <div class="my-form">
                        <div class="text-box form-control-fld terms-and-conditions-block">
                            <div class="col-md-3 padding-none tc-block-fld">
                                <div class="input-prepend">
                                    <input type="text" name="terms_condtion_types2"  placeholder ='Other Charges' class="form-control form-control1 clsGMSOtherCharges"  id="cancellation2" />
                                    <span class="add-on unit">Rs</span>
                                </div>
                            </div>
                ...
                <div class="col-md-12 padding-none">
                    {!! Form::submit('Confirm', ['class' => 'btn theme-btn flat-btn pull-right','name' => 'confirm','id' => 'add_quote_seller_id','onclick'=>"updatepoststatus(1)"]) !!}
