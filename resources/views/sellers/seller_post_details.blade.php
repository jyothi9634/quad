...
{{--*/ $docs_seller_ftl    =   $commoncomponent->getGsaDocuments(SELLER,$serviceId,$seller_post[0]->id,$fromLocationId,$toLocationId); /*--}}      
{{--*/ $docCount_ftl = count($docs_seller_ftl) /*--}}
...
<div class="main">
	...
	<div class="pull-left">
		<div class="info-links" id="seller_post_info_links">
			...
			<a href="#" data-showdiv="ftl-seller-documentation"><i class="fa fa-file-text-o"></i> Documentation <span class="badge">{{ $docCount_ftl }}</span></a>
			</a>
		</div>
	</div>
    ...
    <div id="ftl-seller-documentation" class="table-data text-left tabs-group" {{$docu_style}}>
    	<div class="table-data inner-block-bg text-center">                                       
                                        
        	@if($docCount_ftl>0)                                     
            	<div class="col-sm-12 padding-right-none">
            		<h3>List of documents </h3> 
                    <ul class="popup-list">                                               
                    	@foreach($docs_seller_ftl as $doc)
                        	<li>{{$doc}}</li>
                        @endforeach
                    </ul>
                </div>
    ...
    <div class="table-data text-left tabs-group" id="ftl-seller-documentation" style="display:none;">
