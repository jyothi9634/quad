...
class PtlSellerComponent {
	public static function getPtlSellerSearchList($roleId, $serviceId, $statusId) {
		// print_R($_GET);exit;
...
//		echo "From - ".$_REQUEST ['from_location_id']." To - ".$_REQUEST ['to_location_id'];
		...
		$grid->row ( function ($row) {
			...
			$getSellerpost  = DB::table('ptl_seller_post_items')
			...
			$row->cells [5]->value = '';
							...
							<div class="col-md-12 padding-none">
								...
								<div class="col-md-3 form-control-fld padding-left-none form-control-fld padding-top">
									<span class="data-head">Rate per Kg </span> <span class="data-value"> Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_rate_per_kg).' </span>
										<input type="hidden" 
								...
								<input type="text" name="initial_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'" 
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="initial_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'"
									placeholder="Rate per Kg *" class="ptl_initial_rate_per_kg fourdigitstwodecimals_deciVal numberVal form-control  form-control1" ></div>';
								...
								<div class="col-md-3 form-control-fld padding-left-none form-control-fld padding-top">
                                    ...
                                    placeholder="Conversion Kg/CFT *" class="ptl_initial_conversion fourdigitsthreedecimals_deciVal numberVal form-control  form-control1" >';
								...
								$row->cells [5]->value .= '<div class="clearfix"></div>
										<div class="col-md-12 col-sm-12 col-xs-12 padding-none">';
								$row->cells [5]->value .= '<div class="col-md-3 form-control-fld col-sm-3 col-xs-6 padding-none"><span class="data-head">Pickup </span> <span class="data-value">Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_pick_up_rupees).' </span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 form-control-fld col-sm-3 col-xs-6 padding-none"><span class="data-head">Delivery </span> <span class="data-value">Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_delivery_rupees).' </span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 form-control-fld col-sm-3 col-xs-6 padding-none"><span class="data-head">ODA </span> <span class="data-value">Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_oda_rupees).' </span></div>';
								...
								<span class="data-head">Freight Amount </span><span class="data-value" >Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_freight_amount).' </span>
								
								</div>
								<div class="col-md-3 form-control-fld padding-none margin-top-none">
								<span class="data-head">Total Amount </span><span class="data-value" >Rs '.CommonComponent::getPriceType($getInitialQuotePrice[0]->initial_quote_price).' </span>
								...
								if(isset($getCounterQuotePrice[0]->counter_rate_per_kg) && $getCounterQuotePrice[0]->counter_rate_per_kg !='')
										$row->cells [5]->value .='
											...
											<div class="col-md-3 form-control-fld padding-left-none">
												<span class="data-head">Rate per Kg </span> <span class="data-value"> Rs '.CommonComponent::getPriceType($getCounterQuotePrice[0]->counter_rate_per_kg).'  </span></div>
													<input type="hidden"
								...
								<div class="col-md-3 form-control-fld padding-left-none form-control-fld"><span class="data-head">Conversion KG / CFT </span> <span class="data-value"> '.$getCounterQuotePrice[0]->counter_kg_per_cft.' KG </span></div>
									<input type="hidden"
											...
											<div class="col-md-3 form-control-fld padding-none margin-top-none">
												<span class="data-head">Freight Amount  </span><span class="data-value" >Rs '.CommonComponent::getPriceType($getCounterQuotePrice[0]->counter_freight_amount).' </span>
												
											</div>
											<div class="col-md-3 form-control-fld padding-none margin-top-none">
												<span class="data-head">Total Amount  </span><span class="data-value" >Rs '.CommonComponent::getPriceType($getCounterQuotePrice[0]->counter_quote_price).' </span>
								...
								$row->cells [5]->value .='<div class="hide-final">';
									...
									<div class="col-md-3 form-control-fld padding-left-none form-control-fld margin-bottom-none"><span class="data-head">Rate per Kg </span> <span class="data-value"> Rs '.CommonComponent::getPriceType($getFinalQuotePrice[0]->final_rate_per_kg).' </span></div>'; 
								...
								elseif(isset($getFinalQuotePrice[0]->final_kg_per_cft) && $getFinalQuotePrice[0]->final_kg_per_cft=='' && $getInitialQuotePrice[0]->initial_kg_per_cft!=''  &&  $getCounterQuotePrice[0]->counter_rate_per_kg!='')
                                    ...
                                    placeholder="Conversion Kg/CFT *" class="ptl_final_conversion form-control form-control1 numberVal fourdigitsthreedecimals_deciVal" ></div>
								...
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000'){
									if($dpickup == 1){
			                            ...
			                            data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"  
			                            id="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'" 
	                                    placeholder="Pickup Rs *" class="ptl_initial_pickup fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '
										<input type="text"
	                                    ...
	                                    placeholder="No Pickup Rs *" class="form-control fourdigitstwodecimals_deciVal form-control1 numberVal " readonly>
			                            <input type="hidden"
	                                    name="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'"
			                            data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
			                            id="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'"
								...
								elseif(isset($getCounterQuotePrice[0]->counter_quote_price) && $getCounterQuotePrice[0]->counter_quote_price !='0.0000' && isset($getFinalQuotePrice[0]->final_quote_price) && $getFinalQuotePrice[0]->final_quote_price=='0.0000'){
									if($dpickup == 1){
                	                    ...
                	                    placeholder="Pickup Rs *" class="ptl_final_pickup fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '
										<input type="text"
								...
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000'){
									if($ddelivery == 1){
	                                    ...
	                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
	                                    id="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'" 
			                            placeholder="Delivery Rs *" class="ptl_initial_delivery fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .='<input type="text"
										name="initial_quote_delivery"
	                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
	                                    id="initial_quote_delivery"
			                            placeholder="No Delivery Rs *" class="form-control fourdigitstwodecimals_deciVal form-control1 numberVal " readonly>
	                                    		<input type="hidden"
										name="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
	                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
	                                    id="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
								...
								elseif(isset($getCounterQuotePrice[0]->counter_quote_price) && $getCounterQuotePrice[0]->counter_quote_price !='0.0000' && isset($getFinalQuotePrice[0]->final_quote_price) && $getFinalQuotePrice[0]->final_quote_price=='0.0000'){
									if($ddelivery == 1){
	                                    ...
	                                    placeholder="Delivery Rs *" class="ptl_final_delivery fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '
										<input type="text"
								...
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000'){
                                    ...
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="initial_quote_oda_'.$buyer_id.'_'.$buyer_quote_id.'" 
                                    placeholder="ODA Rs *" class="ptl_initial_oda fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '<input type="text"
									name="initial_quote_oda"
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
                                    id="initial_quote_oda"
                                    placeholder="No ODA Rs *" class="form-control fourdigitstwodecimals_deciVal form-control1 numberVal " readonly>
                                    		<input type="hidden"
									name="initial_quote_oda_'.$buyer_id.'_'.$buyer_quote_id.'"
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
                                    id="initial_quote_oda_'.$buyer_id.'_'.$buyer_quote_id.'"
								...
								elseif(isset($getCounterQuotePrice[0]->counter_quote_price) && $getCounterQuotePrice[0]->counter_quote_price !='0.0000' && isset($getFinalQuotePrice[0]->final_quote_price) && $getFinalQuotePrice[0]->final_quote_price=='0.0000'){
									if($odacheck == 1){
	                                    ...
	                                    placeholder="ODA Rs *" class="ptl_final_oda fourdigitstwodecimals_deciVal form-control form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '
									<input type="text"
								...
								elseif(isset($getInitialQuotePrice[0]->final_freight_amount) && $getInitialQuotePrice[0]->final_freight_amount!='')
									$row->cells [5]->value .= '
														<div class="col-md-3 form-control-fld padding-none margin-top-none">
												<span class="data-head">Freight Amount :  </span><span class="data-value" id="freight_charges_'.$buyer_id.'_'.$buyer_quote_id.'"> Rs '.CommonComponent::getPriceType($getFinalQuotePrice[0]->final_freight_amount).' </span>
												
											</div>
											<div class="col-md-3 form-control-fld padding-none margin-top-none">
												<span class="data-head">Total Amount  </span><span class="data-value" id="total_charges_'.$buyer_id.'_'.$buyer_quote_id.'">Rs '.CommonComponent::getPriceType($getFinalQuotePrice[0]->final_quote_price).' </span>
		...
		$filter = DataFilter::source ( $Query_buyers_for_sellers );
		 ...
		 $filter->add ( 'lkp_packaging_type_id', 'Package Type', 'select')->options($packaging_types)->attr("class","form-control form-control1 numberVal ")->attr("onchange","this.form.submit()");
		 $filter->add ( 'lkp_load_type_id', 'Load Type', 'select')->options($load_types)->attr("class","form-control form-control1 numberVal ")->attr("onchange","this.form.submit()");
	...
	public static function checkUniqueZone($data) {
		$isCodeExist = PtlZone::Where ( 'zone_code', $data ['zone_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
		$isNameExist = PtlZone::Where ( 'zone_name', $data ['zone_name'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
	...
	public static function checkUniqueTier($data) {
		$isCodeExist = PtlTier::Where ( 'tier_code', $data ['tier_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
		$isNameExist = PtlTier::Where ( 'tier_name', $data ['tier_name'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
		if (!empty ( $isNameExist )) {
			return 'This name has been used, Please use another name.';
		} elseif (!empty ( $isCodeExist )) {
			return 'This code has been used, Please use another code.';
	...
	public static function checkUniqueSector($data) {
		$isCodeExist = PtlSector::Where ( 'sector_code', $data ['sector_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
		$isNameExist = PtlSector::Where ( 'sector_name', $data ['sector_name'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->first ();
		if (!empty ( $isNameExist )) {
			return 'This name has been used, Please use another name.';
		} elseif (!empty ( $isCodeExist )) {
			return 'This code has been used, Please use another code.';
	...
	public static function checkUniqueZoneCode($data) {
		$isCodeExist = PtlZone::Where ( 'zone_code', $data ['zone_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->where('id','<>',$data ['id'])->first ();
	...
	public static function checkUniqueZoneName($data) {
		...
		$isNameExist = PtlZone::Where ( 'zone_name', $data ['zone_name'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where ( 'lkp_service_id', Session::get('service_id') )->where('id','<>',$data ['id'])->first ();
	...
	public static function checkUniqueTierCode($data) {
		$isCodeExist = PtlTier::Where ( 'tier_code', $data ['tier_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where('id','<>',$data ['id'])->where ( 'lkp_service_id', Session::get('service_id') )->first ();
	...
	public static function checkUniqueTierName($data) {
		...
		$isNameExist = PtlTier::Where ( 'tier_name',$data ['tier_name'])->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where('id','<>',$data ['id'])->where ( 'lkp_service_id', Session::get('service_id') )->first ();
	...
	public static function checkUniqueSectorCode($data) {
		$isCodeExist = PtlSector::Where ( 'sector_code', $data ['sector_code'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where('id','<>',$data ['id'])->where ( 'lkp_service_id', Session::get('service_id') )->first ();
	...
	public static function checkUniqueSectorName($data) {
		...
		$isNameExist = PtlSector::Where ( 'sector_name', $data ['sector_name'] )->Where ( 'seller_id', Auth::User()->id )->Where ( 'is_active', 1 )->where('id','<>',$data ['id'])->where ( 'lkp_service_id', Session::get('service_id') )->first ();
        ...
        public static function checkUniquePincode($ptlPincodeId,$ptl_sector_id) {
	
		$isNameExist = PtlPincodexsector::Where ( 'ptl_pincode_id', $ptlPincodeId )
                        ->Where ( 'seller_id', Auth::User()->id )
                        ->Where ( 'ptl_sector_id', $ptl_sector_id )
                        ->where ( 'lkp_service_id', Session::get('service_id') )
                        ->first ();
	
		if (!empty ( $isNameExist )) {
			return 'This Pincode has been used in this Sector.Please use another one';
		} else {
			return '1';
		}
	}
	
	public static function getZoneGrid(){


		
		// query to retrieve seller posts list and bind it to the grid
		$Query = DB::table ( 'ptl_zones as pz' );
		$Query->where('seller_id',Auth::User()->id);
		$Query->where('is_active',1); 
		
		$Query->where ( 'lkp_service_id', Session::get('service_id') );
		...
		$grid->add ( 'zone_name', 'Zone Name',  false )->attributes(array("class" => "col-md-4 padding-none"));
		$grid->add ( 'zone_code', 'Zone Code',  false )->attributes(array("class" => "col-md-4 padding-none"));
		$grid->add ( 'edit', 'Edit', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-2 center-fld text-center padding-none"));
		$grid->add ( 'delete', 'Delete', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-2 center-fld text-center padding-none"));
		...
		$grid->row ( function ($row) {
			$row->cells [0]->style ( 'display:none' );
			$zoneId = $row->cells [0]->value;
			$zoneName = $row->cells [1]->value ;			
			$zoneCode = $row->cells [2]->value;
		
			$row->cells [3]->style ( 'text-align:center' );
			$row->cells [4]->style ( 'text-align:center' );
			$row->cells [2]->value = "<span id ='zoneCode_$zoneId'> $zoneCode</span>";
			$row->cells [1]->value ="<span id ='zoneName_$zoneId'> $zoneName</span>";
			
			
			$row->cells [3]->value = "<a href='#'class='red editZone' id = 'editZone' data-idzone =$zoneId data-toggle='modal' data-target='#editZoneModal'><i class='fa fa-edit' title='Edit'></i></a>";
			$row->cells [4]->value = "<a href='#'class='red deleteZone' id = 'deleteZone' data-idzone =$zoneId><i class='fa fa-trash' title='Delete'></i></a>";
			
			
			
			$row->cells [1]->attributes(array("class" => "col-md-4 padding-none"));
			$row->cells [2]->attributes(array("class" => "col-md-4 padding-none"));
			$row->cells [3]->attributes(array("class" => "col-md-2 center-fld text-center padding-none"));
			$row->cells [4]->attributes(array("class" => "col-md-2 center-fld text-center padding-none"));
		
			//$data_link = url()."/sellerposts/$zoneId";
	...
	public static function getTierGrid(){
			// query to retrieve seller posts list and bind it to the grid
			$Query = DB::table ( 'ptl_tiers' );
			$Query->where('seller_id',Auth::User()->id);
			...
			$grid->add ( 'id', 'ID', true )->style ( "display:none" );
			$grid->add ( 'tier_name', 'Tier Name', true )->attributes(array("class" => "col-md-4 col-sm-4 col-xs-4 padding-none"));
			$grid->add ( 'tier_code', 'Tier Code',  true )->attributes(array("class" => "col-md-4 col-sm-4 col-xs-4 padding-none"));
			$grid->add ( 'edit', 'Edit', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-2 col-sm-2 col-xs-2 padding-none"));
			$grid->add ( 'delete', 'Delete', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-2 col-sm-2 col-xs-2 padding-none"));
			...
			$grid->row ( function ($row) {
				$row->cells [0]->style ( 'display:none' );
				$tierId = $row->cells [0]->value;
				$tierName = $row->cells [1]->value ;
				$tierCode = $row->cells [2]->value;
		
				$row->cells [3]->style ( 'text-align:center' );
				$row->cells [4]->style ( 'text-align:center' );
				$row->cells [2]->value = "<span id ='tierCode_$tierId'> $tierCode</span>";
				$row->cells [1]->value ="<span id ='tierName_$tierId'> $tierName</span>";
					
					
				$row->cells [3]->value = "<a class='red editTier' id = 'editTier' data-idtier =$tierId data-toggle='modal' data-target='#editTierModal'><i class='fa fa-edit' title='Edit'></i></a>";
				$row->cells [4]->value = "<a  class='red deleteTier' id = 'deleteTier' data-idtier =$tierId><i class='fa fa-trash' title='Delete'></i></a>";
				...
				$row->cells [4]->attributes(array("class" => "col-md-2 col-sm-2 col-xs-2 padding-none"));
	...
	public static function getSectorGrid(){
		// query to retrieve seller posts list and bind it to the grid
		$Query = DB::table ( 'ptl_sectors as ps' )->leftjoin ( 'ptl_zones as pz', 'ps.ptl_zone_id', '=', 'pz.id' );
		$Query->leftjoin ( 'ptl_tiers as pt', 'ps.ptl_tier_id', '=', 'pt.id' );
		$Query->Where ( 'ps.seller_id', Auth::User ()->id );
		$Query->Where ( 'ps.is_active', 1 );
		$Query->where ( 'ps.lkp_service_id', Session::get('service_id') );
		$Query->select ('ps.ptl_zone_id','ps.ptl_tier_id', 'ps.id', 'pz.zone_name as zone_name', 'pt.tier_name as tier_name', 'ps.sector_name as sector_name', 'ps.sector_code as sector_code' );
		//sorting
		...
		$grid->add ( 'id', 'ID', true )->style ( "display:none" );
		$grid->add ( 'sector_name', 'Sector Name', true )->attributes(array("class" => "col-md-2 padding-none"));
		$grid->add ( 'sector_code', 'Sector Code', true )->attributes(array("class" => "col-md-2 padding-none"));
		$grid->add ( 'zone_name', 'Zone Name', true )->attributes(array("class" => "col-md-3 form-control-fld padding-none"));
		$grid->add ( 'tier_name', 'Tier Name', true )->attributes(array("class" => "col-md-3 form-control-fld padding-none"));
		
		$grid->add ( 'edit', 'Edit', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-1 padding-none"));
		$grid->add ( 'delete', 'Delete', '' )->style ( 'text-align:right' )->attributes(array("class" => "col-md-1 padding-none"));
                $grid->add ( 'ptl_zone_id', 'Zone', true )->style ( 'display:none' );
		$grid->add ( 'ptl_tier_id', 'Tier', true )->style ( 'display:none' );
		$grid->orderBy ( 'id', 'desc' );
		$grid->paginate ( 5 );
		...
		$grid->row ( function ($row) {
			$row->cells [0]->style ( 'display:none' );
			$sectorId = $row->cells [0]->value;
			$sectorName = $row->cells [1]->value ;
			$sectorCode = $row->cells [2]->value;
			$zoneName = $row->cells [3]->value ;
			$tierName = $row->cells [4]->value;
                        $zone = $row->cells [7]->style ( 'display:none' );
			$tier = $row->cells [8]->style ( 'display:none' );
	
			$row->cells [5]->style ( 'text-align:center' );
			$row->cells [6]->style ( 'text-align:center' );
			$row->cells [2]->value = "<span id ='sectorCode_$sectorId'> $sectorCode</span>";
			$row->cells [1]->value ="<span id ='sectorName_$sectorId'> $sectorName</span>";
			$row->cells [3]->value = "<span id ='zoneName_$sectorId' zone_id='$zone'> $zoneName</span>";
			$row->cells [4]->value ="<span id ='tierName_$sectorId' tier_id='$tier'> $tierName</span>";
				
				
			$row->cells [5]->value = "<a class='red editSector' id = 'editSector' data-idsector =$sectorId data-toggle='modal' data-target='#editSectorModal'><i class='fa fa-edit' title='Edit'></i></a>";
			$row->cells [6]->value = "<a  class='red deleteSector' id = 'deleteSector' data-idsector =$sectorId><i class='fa fa-trash' title='Delete'></i></a>";
				
			$row->cells [1]->attributes(array("class" => "col-md-2 padding-none"));
			$row->cells [2]->attributes(array("class" => "col-md-2 padding-none"));
			$row->cells [3]->attributes(array("class" => "col-md-3 form-control-fld padding-none"));
			$row->cells [4]->attributes(array("class" => "col-md-3 form-control-fld padding-none"));
	...
	public static function getPincodeGrid(){

		// query to retrieve seller posts list and bind it to the grid
		$Query =  DB::table ( 'ptl_pincodexsectors as pxs' );
		$Query  ->leftjoin ( 'lkp_ptl_pincodes as lpp', 'pxs.ptl_pincode_id', '=', 'lpp.id' );
		$Query	->leftjoin ( 'ptl_sectors as ps', 'pxs.ptl_sector_id', '=', 'ps.id' );
		$Query	->leftjoin ( 'ptl_zones as pz', 'ps.ptl_zone_id', '=', 'pz.id' );
		$Query	->leftjoin ( 'ptl_tiers as pt', 'ps.ptl_tier_id', '=', 'pt.id' );
		$Query	->Where ( 'pxs.seller_id', Auth::User ()->id );
		$Query	->where ( 'pxs.lkp_service_id', Session::get('service_id') );
		$Query	->where ( 'pxs.is_active', '1') ;
		$Query	->select ( 'pxs.*','lpp.pincode as pincode', 'pz.zone_name as zone_name', 'pt.tier_name as tier_name', 'ps.sector_name as sector_name',DB::raw('(CASE WHEN pxs.oda=1 THEN "Yes" ELSE "No" END) AS oda') );
		...
		$grid->add ( 'id', 'ID', true )->style ( "display:none" );
		$grid->add ( 'pincode', 'Pincode', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'location', 'Location', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'city', 'City', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'sector_name', 'Sector', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'postal_division', 'Postal Div.', true )->attributes(array("class" => "col-md-1 padding-none"));
		$grid->add ( 'district', 'District', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'state', 'State', true )->attributes(array("class" => "col-md-2 padding-left-none"));
		$grid->add ( 'zone_name', 'Zone ', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'tier_name', 'Tier ', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		$grid->add ( 'oda', 'ODA', true )->attributes(array("class" => "col-md-1 padding-left-none"));
		
		$grid->add ( 'actions', 'Actions', '' )->style ( 'text-align:center' )->attributes(array("class" => "col-md-1 padding-none text-center"));
		...
		$grid->row ( function ($row) {
			$row->cells [0]->style ( 'display:none' );
			$pincodeId = $row->cells [0]->value;
			
		
			$row->cells [11]->style ( 'text-align:left' );
			
			$row->cells [11]->value = "<a  class='red deletePincode' id = 'deletePincode' data-idpincode = $pincodeId><i class='fa fa-trash' title='Delete'></i></a>";
		
			$row->cells [1]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [2]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [3]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [4]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [5]->attributes(array("class" => "col-md-1 padding-none"));
			$row->cells [6]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [7]->attributes(array("class" => "col-md-2 padding-left-none"));
			$row->cells [8]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [9]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [10]->attributes(array("class" => "col-md-1 padding-left-none"));
			$row->cells [11]->attributes(array("class" => "col-md-1 padding-none text-center"));
			//$row->cells [12]->attributes(array("class" => "col-md-1 padding-none"));
