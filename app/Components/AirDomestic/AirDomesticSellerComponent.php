...
class AirDomesticSellerComponent {
	public static function getAirDomesticSellerSearchList($roleId, $serviceId, $statusId) {
		...
		$grid->row ( function ($row) {
			...
			$buyerdetailsvalue = DB::table ( 'airdom_buyer_quote_items' )->where ( 'airdom_buyer_quote_items.id', '=', $buyer_quote_id )->select ( 'airdom_buyer_quote_items.*' )->get ();
		...
		$delivery_date_buyer_convert = CommonComponent::checkAndGetDate($delivery_date_buyer);
			...
			$getSellerpost  = DB::table('airdom_seller_post_items')
			->join( 'airdom_seller_posts', 'airdom_seller_posts.id', '=', 'airdom_seller_post_items.seller_post_id' )
			->join( 'airdom_buyer_quote_sellers_quotes_prices', 'airdom_buyer_quote_sellers_quotes_prices.seller_post_item_id', '=', 'airdom_seller_post_items.id' )
			->where('airdom_seller_post_items.from_location_id','=',$from_zipcode)
			->where('airdom_seller_post_items.to_location_id','=',$to_zipcode)
			->where('airdom_seller_post_items.created_by','=',Auth::user()->id)
			->where('airdom_buyer_quote_sellers_quotes_prices.buyer_quote_id','=',$bqid)
			->where('airdom_seller_posts.lkp_post_status_id','=',OPEN)
			->select('airdom_seller_post_items.seller_post_id',
					'airdom_seller_post_items.id',
					'airdom_seller_posts.tracking',
					'airdom_seller_posts.lkp_payment_mode_id',
					'airdom_seller_posts.accept_payment_netbanking',
					'airdom_seller_posts.accept_payment_credit',
					'airdom_seller_posts.accept_payment_debit',
					'airdom_seller_posts.credit_period',
					'airdom_seller_posts.credit_period_units',
					'airdom_seller_posts.accept_credit_netbanking',
					'airdom_seller_posts.accept_credit_cheque')
					->get();
			...
			$locationids = DB::table('airdom_buyer_quotes')
			->leftjoin('airdom_buyer_quote_items','airdom_buyer_quote_items.buyer_quote_id','=','airdom_buyer_quotes.id')
			->where('airdom_buyer_quote_items.id','=',$buyer_quote_id)
			->select('airdom_buyer_quotes.from_location_id','airdom_buyer_quotes.to_location_id')
			->get();
			...
			$row->cells [5]->value .= '';
							...
							$quoteid = DB::table('airdom_buyer_quote_items')
							->where('airdom_buyer_quote_items.id','=',$buyer_quote_id)
							->select('airdom_buyer_quote_items.buyer_quote_id')
							->get();
							
							$quoteitems = DB::table('airdom_buyer_quote_items')
							->join('lkp_load_types','lkp_load_types.id','=','airdom_buyer_quote_items.lkp_load_type_id')
							->join('lkp_packaging_types','lkp_packaging_types.id','=','airdom_buyer_quote_items.lkp_packaging_type_id')
							->where('airdom_buyer_quote_items.buyer_quote_id','=',$quoteid[0]->buyer_quote_id)
							->select('airdom_buyer_quote_items.*','lkp_load_types.load_type','lkp_packaging_types.packaging_type_name')
							->get();
								...
								<div class="table pull-right">
									...
									<div class="table-data">
										<div class="table-row inner-block-bg">
											...
											<div class="col-md-2 padding-left-none">'.round($quoteitems[$i]->calculated_volume_weight,4).' CCM </div>';
							...
							<div class="col-md-12 padding-none">
								...
								<div class="col-md-3 padding-left-none form-control-fld padding-top">
									...
									placeholder="Rate per Kg *" class="form-control fourdigitstwodecimals_deciVal form-control1 numberVal " value="'.$getInitialQuotePrice[0]->initial_rate_per_kg.'" >
										'; 
									else
										$row->cells [5]->value .= '
								<div class="col-md-3 padding-left-none form-control-fld padding-top">
								<input type="text" name="initial_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'" 
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="initial_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'"
									placeholder="Rate per Kg *" class="ptl_initial_rate_per_kg form-control  fourdigitstwodecimals_deciVal numberVal form-control1" >';
								...
								if(isset($getInitialQuotePrice[0]->initial_kg_per_cft) && $getInitialQuotePrice[0]->initial_kg_per_cft!='')
									$row->cells [5]->value .='
								<div class="col-md-3 padding-left-none form-control-fld padding-top">
									<span class="data-head"> Conversion KG / CCM </span><span class="data-value"> '.$getInitialQuotePrice[0]->initial_kg_per_cft.' KG</span> 
								...
								<div class="col-md-3 padding-left-none form-control-fld padding-top">
                                    ...
                                    placeholder="Conversion Kg/CCM *" class="ptl_initial_conversion form-control  fourdigitsfourdecimals_deciVal numberVal form-control1" >';
									$row->cells [5]->value .='</div>
									<div class="col-md-3 padding-left-none form-control-fld padding-top">
								...
								$row->cells [5]->value .= '
										<div class="col-md-12 col-sm-12 col-xs-12 padding-none">';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Pickup </span> <span class="data-value">Rs '.$getInitialQuotePrice[0]->initial_pick_up_rupees.' /-</span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Delivery </span> <span class="data-value">Rs '.$getInitialQuotePrice[0]->initial_delivery_rupees.' /-</span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">ODA </span> <span class="data-value">Rs '.$getInitialQuotePrice[0]->initial_oda_rupees.' /-</span></div>';
								...
								if(isset($getCounterQuotePrice[0]->counter_rate_per_kg) && $getCounterQuotePrice[0]->counter_rate_per_kg !='')
										$row->cells [5]->value .='
											...
											placeholder="Conversion Kg/CCM *" class="form-control form-group margin-top"  value="'.$getCounterQuotePrice[0]->counter_rate_per_kg.'">
													'; 
									
								if(isset($getCounterQuotePrice[0]->counter_kg_per_cft) && $getCounterQuotePrice[0]->counter_kg_per_cft!=''){
									$row->cells [5]->value .='
								<div class="col-md-3 padding-left-none form-control-fld"><span class="data-head">Conversion KG / CCM </span> <span class="data-value"> '.$getCounterQuotePrice[0]->counter_kg_per_cft.' KG </span></div>
									<input type="hidden"
											name="counter_quote_kgperdft_'.$buyer_id.'_'.$buyer_quote_id.'"
											data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
											id="counter_quote_kgperdft_'.$buyer_id.'_'.$buyer_quote_id.'"
											placeholder="Conversion Kg/CCM *" class="form-control form-group margin-top"  value="'.$getCounterQuotePrice[0]->counter_kg_per_cft.'">
								...
								$row->cells [5]->value .='<div class="hide-final">';
									...
									<div class="col-md-3 padding-left-none form-control-fld margin-bottom-none"><input type="text" 
									name="final_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'" 
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="final_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'"
									placeholder="Rate per Kg *" class="ptl_final_rate_per_kg form-control form-control1 fourdigitstwodecimals_deciVal numberVal numberVal " ></div>';
									
								
								if(isset($getFinalQuotePrice[0]->final_kg_per_cft) && $getFinalQuotePrice[0]->final_kg_per_cft!='')
									$row->cells [5]->value .='
									<div class="col-md-3 padding-left-none form-control-fld margin-bottom-none"><span class="data-head">Conversion KG / CCM </span> <span class="data-value"> '.$getFinalQuotePrice[0]->final_kg_per_cft.' KG</span></div>';
								elseif(isset($getFinalQuotePrice[0]->final_kg_per_cft) && $getFinalQuotePrice[0]->final_kg_per_cft=='' && $getInitialQuotePrice[0]->initial_kg_per_cft!=''  &&  $getCounterQuotePrice[0]->counter_rate_per_kg!='')
                                    ...
                                    placeholder="Conversion Kg/CCM *" class="ptl_final_conversion form-control fourdigitsfourdecimals_deciVal form-control1 numberVal " ></div>
								...
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000'){
									if($dpickup == 1){
	                                    ...
	                                    placeholder="No Pickup Rs *" class="form-control form-control1 fourdigitstwodecimals_deciVal numberVal " readonly>
			                            		<input type="hidden"
	                                    name="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'"
			                            data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
			                            id="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'"
							...
							if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000'){
		                            ...
		                            placeholder="No Delivery Rs *" class="form-control form-control1 fourdigitstwodecimals_deciVal numberVal " readonly>
                                    		<input type="hidden"
									name="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
                                    id="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
		                            placeholder="Delivery Rs *" class="ptl_initial_delivery form-control form-control1 fourdigitstwodecimals_deciVal numberVal " value="0">';
									}
								}
								elseif(isset($getCounterQuotePrice[0]->counter_quote_price) && $getCounterQuotePrice[0]->counter_quote_price !='0.0000' && isset($getFinalQuotePrice[0]->final_quote_price) && $getFinalQuotePrice[0]->final_quote_price=='0.0000'){
									if($ddelivery == 1){
                                    ...
                                    placeholder="Delivery Rs *" class="ptl_final_delivery form-control fourdigitstwodecimals_deciVal form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .= '
									<input type="text"
		                            ...
		                            data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
		                            id="final_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
                                    placeholder="Delivery Rs *" class="ptl_final_delivery form-control fourdigitstwodecimals_deciVal form-control1 numberVal " value="0">';
								...
								elseif(!isset($getInitialQuotePrice[0]->initial_quote_price)){
                                    ...
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
                                    id="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
		                            placeholder="Delivery Rs *" class="ptl_initial_delivery form-control fourdigitstwodecimals_deciVal form-control1 numberVal ">';
									}else{
										$row->cells [5]->value .='<input type="text"
									name="initial_quote_delivery"
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
								...
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Pickup </span> <span class="data-value">Rs '.$getFinalQuotePrice[0]->final_pick_up_rupees.' /-</span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Delivery </span> <span class="data-value">Rs '.$getFinalQuotePrice[0]->final_delivery_rupees.' /-</span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">ODA </span> <span class="data-value">Rs '.$getFinalQuotePrice[0]->final_oda_rupees.' /-</span></div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Transit Days </span> <span class="data-value">'.$getFinalQuotePrice[0]->final_transit_days.'</span></div>';
								}	
