...
class OceanSellerComponent {
	public static function getOceanSellerSearchList($roleId, $serviceId, $statusId) {
		// print_R($_GET);exit;
...
//		echo "From - ".$_REQUEST ['from_location_id']." To - ".$_REQUEST ['to_location_id'];
		...
		$grid->add ( 'dispatch_date', 'Dispatch Date', 'dispatch_date' )->attributes ( array ("class" => "col-md-3 padding-left-none") );
		$grid->add ( 'frompincode', 'From Location', 'frompincode' )->attributes ( array ("class" => "col-md-2 padding-left-none") );
		$grid->add ( 'topincode', 'To Location', 'topincode' )->attributes ( array ("class" => "col-md-2 padding-left-none") );
		...
		$grid->row ( function ($row) {
			...
			$getSellerpost  = DB::table('ocean_seller_post_items')
			->join( 'ocean_seller_posts', 'ocean_seller_posts.id', '=', 'ocean_seller_post_items.seller_post_id' )
			->join( 'ocean_buyer_quote_sellers_quotes_prices', 'ocean_buyer_quote_sellers_quotes_prices.seller_post_item_id', '=', 'ocean_seller_post_items.id' )
			->where('ocean_seller_post_items.from_location_id','=',$from_zipcode_id)
			->where('ocean_seller_post_items.to_location_id','=',$to_zipcode_id)
			->where('ocean_seller_post_items.created_by','=',Auth::user()->id)
			->where('ocean_buyer_quote_sellers_quotes_prices.buyer_quote_id','=',$bqid)
			->where('ocean_seller_posts.lkp_post_status_id','=',OPEN)
			->select('ocean_seller_post_items.seller_post_id',
					'ocean_seller_post_items.id',
					'ocean_seller_posts.tracking',
					'ocean_seller_posts.lkp_payment_mode_id',
					'ocean_seller_posts.accept_payment_netbanking',
					'ocean_seller_posts.accept_payment_credit',
					'ocean_seller_posts.accept_payment_debit',
					'ocean_seller_posts.credit_period',
					'ocean_seller_posts.credit_period_units',
					'ocean_seller_posts.accept_credit_netbanking',
					'ocean_seller_posts.accept_credit_cheque')
					->get();
			...
			$row->cells [5]->value .= '';
							...
							<div class="col-md-12 col-sm-12 col-xs-12 padding-none">
								...
								$row->cells [5]->value .= '<div class="table-data">
									...
									$row->cells [5]->value .= '<div class="col-md-2 padding-left-none">'.round($quoteitems[$i]->calculated_volume_weight,4).' CM </div>';
							...
							$row->cells [5]->value .= '<input type="hidden" name="incrementcount_'.$buyer_id.'_'.$buyer_quote_id.'" id="incrementcount_'.$buyer_id.'_'.$buyer_quote_id.'" value="'.$i.'">
							...
							<div class="col-md-12 col-sm-12 col-xs-12 padding-none margin-top ">
								...
								<div class="col-md-3 padding-none"><span class="data-head">Rate per Kg </span> <span class="data-value"> Rs '.$getInitialQuotePrice[0]->initial_rate_per_kg.' /-</span>
									...
									placeholder="Rate per Kg *" class="form-control form-control1 fourdigitstwodecimals_deciVal numberVal  margin-top" value="'.$getInitialQuotePrice[0]->initial_rate_per_kg.'" >
										'; 
									else
										$row->cells [5]->value .= '
								<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><input type="text" 
                                    ...
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="initial_quote_rateperkg_'.$buyer_id.'_'.$buyer_quote_id.'"
									placeholder="Rate per Kg *" class="ptl_initial_rate_per_kg form-control form-control1 fourdigitstwodecimals_deciVal numberVal  margin-top" >';
								...
								if(isset($getInitialQuotePrice[0]->initial_kg_per_cft) && $getInitialQuotePrice[0]->initial_kg_per_cft!='')
                                    ...
                                    placeholder="'.$cft.' *" class="ptl_initial_conversion form-control form-control1 fourdigitsthreedecimals_deciVal numberVal  margin-top" >';
								...
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none">Pickup Rs '.$getInitialQuotePrice[0]->initial_pick_up_rupees.' /-</div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none">Delivery Rs '.$getInitialQuotePrice[0]->initial_delivery_rupees.' /-</div>';
								$row->cells [5]->value .= '<div class="col-md-3 col-sm-3 col-xs-6 padding-none">ODA Rs '.$getInitialQuotePrice[0]->initial_oda_rupees.' /-</div>';
								}
								...
								if(isset($getCounterQuotePrice[0]->counter_rate_per_kg) && $getCounterQuotePrice[0]->counter_rate_per_kg !='')
										$row->cells [5]->value .='
											...
											placeholder="Conversion Kg/CM *" class="form-control form-control1 numberVal  margin-top"  value="'.$getCounterQuotePrice[0]->counter_rate_per_kg.'">
													'; 
								...
								if(isset($getCounterQuotePrice[0]->counter_kg_per_cft) && $getCounterQuotePrice[0]->counter_kg_per_cft!=''){
										...
										<input type="hidden"
											...
											placeholder="Conversion Kg/CM *" class="form-control form-control1 numberVal  margin-top"  value="'.$getCounterQuotePrice[0]->counter_kg_per_cft.'">
								...
								if(isset($getFinalQuotePrice[0]->final_kg_per_cft) && $getFinalQuotePrice[0]->final_kg_per_cft!=''){
										...
										$row->cells [5]->value .='
										<div class="col-md-6 col-sm-6 col-xs-6 padding-none"><span class="data-head">'.$cft.' </span><span class="data-value"> '.$getFinalQuotePrice[0]->final_kg_per_cft.' KG</span></div>';
								...
								elseif(isset($getFinalQuotePrice[0]->final_kg_per_cft) && $getFinalQuotePrice[0]->final_kg_per_cft=='' && $getInitialQuotePrice[0]->initial_kg_per_cft!=''  &&  $getCounterQuotePrice[0]->counter_rate_per_kg!='')
                                    ...
                                    placeholder="'.$cft.' *" class="ptl_final_conversion form-control form-control1 fourdigitsthreedecimals_deciVal numberVal  margin-top" ></div>
								...
								$row->cells [5]->value .='<div class="clearfix"></div>';	
								if(Session::get('service_id') != AIR_INTERNATIONAL && Session::get('service_id') != OCEAN){		
									$row->cells [5]->value .='<div class="col-md-3 col-sm-3 col-xs-6 padding-none">';
									if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000')
			                            ...
			                            data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"  
			                            id="initial_quote_pickup_'.$buyer_id.'_'.$buyer_quote_id.'" 
	                                    placeholder="Pickup Rs *" class="form-control form-control1 numberVal ">';
								...
								$row->cells [5]->value .='<div class="col-md-3 col-sm-3 col-xs-6 padding-right-none">';
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000')
									$row->cells [5]->value .='<input type="text" 
									name="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'"
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"
                                    id="initial_quote_delivery_'.$buyer_id.'_'.$buyer_quote_id.'" 
		                            placeholder="Delivery Rs *" class="form-control form-control1 numberVal ">';
								...
								<div class="col-md-3 col-sm-3 col-xs-6 padding-right-none mobile-padding-none">';
								if(isset($getInitialQuotePrice[0]->initial_quote_price) && $getInitialQuotePrice[0]->initial_quote_price=='0.0000')
                                    ...
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'" 
                                    id="initial_quote_oda_'.$buyer_id.'_'.$buyer_quote_id.'" 
                                    placeholder="ODA Rs *" class="form-control form-control1 numberVal ">';
								...
								if(isset($getInitialQuotePrice[0]->initial_transit_days) && $getInitialQuotePrice[0]->initial_transit_days=='')
                                    ...
                                    data-buyerid="'.$buyer_id.'" dat-buyerqouteit="'.$buyer_quote_id.'"  
                                    id="initial_quote_transit_'.$buyer_id.'_'.$buyer_quote_id.'"
                                    placeholder="Transit Days *" class="form-control form-control1 maxlimitthree_lmtVal numericvalidation ">';
								...
								if(Session::get('service_id') == AIR_INTERNATIONAL || Session::get('service_id') == OCEAN){
									...
									$row->cells [5]->value .= '<div class="col-md-12 col-sm-12 col-xs-12 padding-none">
																<div class="col-md-3 col-sm-3 col-xs-6 padding-none"><span class="data-head">Transit Days </span> <span class="data-value">'.$getFinalQuotePrice[0]->final_transit_days.'</span></div></div>';
									}
								}
								$row->cells [5]->value .= '</div>';
								$row->cells [5]->value .= '<div class="clearfix"></div>';
